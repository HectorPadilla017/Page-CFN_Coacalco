...
const useStyles = makeStyles((theme) => ({
    ...
    gradient: {
        ...
        background: '-webkit-linear-gradient(135deg, rgba(255, 255, 255, 0) 30%, rgba(25, 101, 214, 0.8) 50%, rgba(13, 50, 105, 0.9) 80%)', 
        color: '#fff',
    },
    text: {
    ...
    return (
        <div className={classes.root}>
            <div className={classes.gradient}>
                <Typography className={classes.text} variant='h1' color='inherit'>{props.title}</Typography>
            </div>
            <img 
